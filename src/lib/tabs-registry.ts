...
import {
  ...
  CheckSquare, Bell, Palette, ShieldAlert, type LucideIcon,
} from "lucide-react";
...
export type TabKey =
  ...
  | "security" | "notify"
  | "permissions" | "settings.tabs" | "settings.integrations" | "settings.design";
...
export const TABS: TabDef[] = [
  ...
  { key: "settings.design",       to: "/settings/design",       label: "Design (BETA)",    desc: "Neuromorphic", icon: Palette,  accent: "from-fuchsia-500/30 to-cyan-500/20", category: "settings", beta: true },
