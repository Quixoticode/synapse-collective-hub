...
import {
  ...
  CheckSquare, Bell, Palette, ShieldAlert, UserPlus, type LucideIcon,
} from "lucide-react";

export type TabKey =
  | "apps" | "contacts" | "chat" | "vault" | "workspace" | "basics"
  | "calendar" | "support" | "finances" | "news" | "collective" | "tasks"
  | "security" | "notify" | "apply"
  | "permissions" | "settings" | "settings.tabs" | "settings.integrations" | "settings.design";
